...
import { Autoplay, Navigation, Pagination, Scrollbar, A11y, FreeMode, Mousewheel } from 'swiper/modules';

const Tabscontentsliderhor = () => {
...

                        {
                            card.map((item) => (
                                ...
                                <SwiperSlide>
                                    ...
                                    <Grid container lg={12} md={12} sm={12} xs={12} sx={{ marginBottom: "40px", margin: 0, padding: 0, justifyContent: "center" }}>

                                        <Grid lg={11} md={11} sm={11} xs={11}  sx={{ justifyContent: "center", alignItems: "center", textAlign: "center" }}>
                                        ...
                                        <Grid lg={11} md={11} sm={11} xs={11}  textAlign={'center'}>
...
export default Tabscontentsliderhor;