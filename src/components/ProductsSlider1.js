    ...
    <>
      ...
      <Grid container sx={{ justifyContent: "center", marginBottom: "30px" }}  >
        ...
        <Grid lg={10.5} md={11} sm={11.5} xs={11.6} display={{ xs: 'none', sm: 'block' }} marginTop={3}>
          <Typography color={'#9D673A'} fontSize={'20px'} textAlign={{ xs: 'start', sm: 'center' }} fontFamily={' Poppins,sans-serif'} marginBottom={2} marginTop={5}><b>Check Out More Lawson Sofa Sets</b></Typography>
          <Swiper
...
<Divider
 sx={{
    ...
    borderWidth: '5px', // You can adjust the width of the dots
    borderColor: "#f5f5f5" // Optional: You can add border-radius for rounded dotspx 
}}
/>
