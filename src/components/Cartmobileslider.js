    ...
    <>
      ...
      <Grid container sx={{ justifyContent: "center", marginBottom: "50px" }}  >
        ...
        <Grid xs={11.6} display={{ xs: 'block', sm: 'none' }}>
          <Typography color={'#9D673A'} fontSize={'14px'} textAlign={{ xs: 'start', sm: 'center' }} fontFamily={' Poppins,sans-serif'} marginBottom={2} ><b>Recently Viewed</b></Typography>
          <Swiper
...
export default Cartmobileslider;