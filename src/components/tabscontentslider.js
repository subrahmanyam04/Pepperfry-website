...
import Tabscontentsliderformobile from "./tabscontentsliderformobile";
import Tabscontentsliderhor from "./tabscontentsliderhor";
...
const Tabscontentslider = ({
    ...
    let jaggu = tabdata1.filter(i => i.status == params.catagoery)
    ...
    return (
        ...
        <>
            ...
            <Grid display={{ lg: 'block', md: 'none', sm: 'none', xs: 'none' }} marginTop={2}>
                ...
                >
                    <Grid container sx={{ marginBottom: "40px", margin: 0, padding: 0 }} border={'1px solid black'} >

                        <Grid item lg={3} md={11} sm={11} xs={11} sx={{ justifyContent: "center" }} border={'1px solid black'} >


                            {/* slider grid */}

                            <Grid container >
                                <SwiperSlide > <Grid  ></Grid></SwiperSlide>
                            </Grid>
                                    ...
                                    >
                                        ...
                                        <Grid container lg={12} md={12} sx={{ margin: 0, padding: 0, justifyContent: "center" }} border="0.5px solid lightgrey" >
                                            ...
                                            <Grid lg={11} md={11} sm={12} xs={12} sx={{ justifyContent: "center", alignItems: "center", textAlign: "center" }} >
                                                ...
                                                <img
                                                    src="https://ii1.pepperfry.com/assets/w23-clip-ctg-all.png"
                                                    alt=" ..."
                                                    width="60px"
                                                    height="60px"
                                ...
                                jaggu.map((item, index) => (
                                    ...
                                    <SwiperSlide  >
                                        ...
                                        >
                                            ...
                                            <Grid container lg={12} md={12} sx={{ marginBottom: "40px", margin: 0, padding: 0, justifyContent: "center" }} border={item.border} >
                                                ...
                                                <Grid lg={11} md={11} sm={12} xs={12} textAlign={'center'}>
                                                    <ThemeProvider theme={theme}>
                                                        <Typography fontSize={'12px'} color={'#121212'} >{item.title}</Typography>
                                                        <Typography fontSize={'12px'} color={'#848484'}>{item.option}</Typography>
                                                    </ThemeProvider>
                                                </Grid>
                            ...
                            <SwiperSlide> <Grid lg={4} ></Grid></SwiperSlide>
            ...
            {/* // from medium screens */}
            <Tabscontentsliderformobile />

            {/* for mobile screens horizontal scrollbar */}
            <Tabscontentsliderhor />
...
export default connect(mapStateToProps, mapDispatchToProps)(Tabscontentslider);